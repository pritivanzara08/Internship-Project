  ...
  return (
    <AdminLayout>
      <div>
        ...
        <p>
          {" "}
          Overview widgets and metrics appear here. Connect to your MongoDB
          backend to populate these in real-time.{" "}
        </p>{" "}
        <div
          style={{
            display: "grid",
        ...
        >
          ...
          {widgets.map((w) => (
            ...
            >
              {" "}
              <div style={{ fontSize: 14, color: "#888" }}>{w.title}</div>{" "}
        ...
        <div style={{ marginTop: 32 }}>
          ...
          <ul style={{ paddingLeft: 20, color: "#555" }}>
            ...
            <li>Product "Custom Mug" stock updated</li>{" "}
